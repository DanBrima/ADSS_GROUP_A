...
public class Constants {
    ...
    public static final int TURN_OFF_INDEX = 4;
    ...
    public static final int DISPLAY_CONTRACTS_INDEX = 1;

    // Data functionality ?
    public static final String ADD_CONTRACT = "Add supplier contract";
    public static final int ADD_CONTRACT_INDEX = 2;
